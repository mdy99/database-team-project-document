...
CREATE TABLE GAME_SESSION (
    ...
    PAWNSHOP_DEBT NUMBER(9) DEFAULT 500000, -- 남은(갚아야 하는) 전당포 빚
...
CREATE TABLE EXISTING_ITEM(
    ...
    CONSTRAINT CK_EXISTING_ITEM_AUTHENTICITY_ CHECK (FOUND_FLAW_EA <= FLAW_EA),
);
...
CREATE TABLE DEAL_RECORD(
    ...
    SELLER_KEY NUMBER(9) NOT NULL REFERENCES CUSTOMER(CUSTOMER_KEY), --FK 물건 판매 고객 키
    BUYER_KEY NUMBER(9) REFERENCES CUSTOMER(CUSTOMER_KEY), -- FK 물건 구매 고객 키. 판매 전까지는 NULL
...
CREATE TABLE CUSTOMER_HIDDEN_DISCOVERED_IN_GAME_SESSION(
    ...
    CUSTOMER_KEY NUMBER(9) NOT NULL,
        CONSTRAINT FK_CUSTOMER_HIDDEN_DISCOVERED_IN_GAME_SESSION_CUSTOMER FOREIGN KEY (CUSTOMER_KEY) REFERENCES CUSTOMER(CUSTOMER_KEY),
